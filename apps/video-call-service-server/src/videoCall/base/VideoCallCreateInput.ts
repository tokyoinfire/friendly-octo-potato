...
class VideoCallCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => VideoCallParticipantCreateNestedManyWithoutVideoCallsInput,
  })
  @ValidateNested()
  @Type(() => VideoCallParticipantCreateNestedManyWithoutVideoCallsInput)
  @IsOptional()
  @Field(() => VideoCallParticipantCreateNestedManyWithoutVideoCallsInput, {
    nullable: true,
  })
  videoCallParticipants?: VideoCallParticipantCreateNestedManyWithoutVideoCallsInput;
}

export { VideoCallCreateInput as VideoCallCreateInput };
